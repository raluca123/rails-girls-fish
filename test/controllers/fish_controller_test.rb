...
class FishControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post fish_index_url, params: { fish: { age: @fish.age, family: @fish.family, name: @fish.name, picture: @fish.picture } }
    end
  ...
  test "should update fish" do
    patch fish_url(@fish), params: { fish: { age: @fish.age, family: @fish.family, name: @fish.name, picture: @fish.picture } }
